      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex justify-between mb-6">
            <h2 className="text-2xl text-yellow-400 font-bold">Licence Reports</h2>
            <button className="bg-yellow-400 text-black px-4 py-1 rounded">Print Report</button>
          </div>
          ...
          {drivers.map((driver, index) => (
            ...
            <div key={index} className="grid grid-cols-4 border-b border-gray-700 py-3">
              ...
              <div className={driver.licenceStatus === "Active" ? "text-green-400" : "text-red-500"}>
                {driver.licenceStatus === "Active" ? "Updated" : "Missing"}
              </div>

              <button
                onClick={() => navigate(`/licence-report/${driver.id}`)}
